  ...
  return (
    <header className="header">
      <div className="header-logo-dropdowns-wrapper">
        <svg viewBox="0 0 101 40" xmlns="http://www.w3.org/2000/svg" className="logo">
          <path
        ...
        <nav className="header-nav-dropdowns-container">
          <ul className="header-dropdowns-container">
